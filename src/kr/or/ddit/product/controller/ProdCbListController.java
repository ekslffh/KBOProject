...
@WebServlet("/ProdCbListController")
public class ProdCbListController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public ProdCbListController() {
        super();
    }
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("prodCbList.jsp").forward(req, resp);

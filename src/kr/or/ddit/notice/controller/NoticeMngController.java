...
@WebServlet("/NoticeMngController")
public class NoticeMngController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public NoticeMngController() {
        super();
    }
...
//		
//		if(msName.equals("MANAGER")) {
//			request.getRequestDispatcher("/manager/noticeMng.jsp?msName=" + msName +"&cbNo=" + cbNo).forward(request, response);
//			return;
//		}
		
		request.getRequestDispatcher("/manager/noticeMng.jsp").forward(request, response);

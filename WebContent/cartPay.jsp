...
ArrayList<OrDetailVO> orDetailList = (ArrayList<OrDetailVO>) request.getAttribute("orDetail");   
PayVO pay = (PayVO) request.getAttribute("pay");
   List<cartProdDto> cartProd = (List<cartProdDto>) request.getAttribute("cartProd"); 
...
<!-- onclick="location.href='Notice'" -->
            <div class="text-end" style="margin: 10px 30px" style="display:flew;">

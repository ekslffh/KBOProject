...
<%
	TicketVO tv = (TicketVO) request.getAttribute("tv");
%>
	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5">
				...
				<div class="col-md-5">
						<button type="button" class="btn btn-secondary btn-lg" onclick="location.href='tiketCancleOk?tNo=<%=tv.gettNo()%>'">예매취소</button>
				</div>
			</div>
		</div>
	</section>

  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark" style="height: 92px;">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container px-4 px-lg-5">
			<a class="navbar-brand" href="#"><b>전체 상품</b></a>
				...
				<ul class="navbar-nav ms-auto py-4 py-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item"
								href="ProdCbListController?cbNo=<%=club%>"><%=clubName%></a></li>
							<%
								}
							%>
						</ul></li>
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							%>
							<li><a class="dropdown-item"
								href="ProdCgListController?cgName=<%=category%>"><%=category%></a></li>
							<%
								}
							%>
						</ul>
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto"
									href="ProdDetailController?prodNo=<%=pv.getProdNo()%>">상세보기</a>
							</div>
						</div>
					</div>
				</div>

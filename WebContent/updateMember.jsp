				...
				<div class="col-md-12">
					...
					<form class="form-horizontal" action="test.jsp" method="post"
						...
						<div class="row g-3">
							...
							<div class="form-group">
								<label for="id" class="form-label">아이디 <span class="rq">
										*</span></label> <input type="text" class="form-control" id="id"
									name="memId" placeholder="Enter Id"
									pattern="[a-zA-Z][a-zA-Z0-9]{5,16}" required> 
									<span class="point">첫 자리 영문, 나머지는 영문+숫자, 5-15글자 내로 입력하여 주십시오.</span>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="password" class="form-control" id="pwChk"
									...
									pattern="(?=.*?[a-z])(?=.*?[0-9])(?=.*?[!@#$%^&*()_+|]).{8,12}" required>
							</div>
							<div class="col-sm-6" style="text-align: left">
								<button type="button" class="btn btn-success btn-sm" id="pwChkBtn">확인</button>
								<span id="disp2"></span>
							</div>
							<br>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6" style="text-align: left;">
								<button type="button" id="telBtn" class="btn btn-success btn-sm">인증
									번호 보내기</button>
								<span id="disp3"></span>
							</div>
							<br>
						...
						<div class="form-group">
							<label for="telChk" class="control-label col-sm-2">인증번호 <span
								class="rq"> *</span></label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-6">
								<button class="w-75 btn btn-primary btn-md" type="submit"> 가입하기 </button>
